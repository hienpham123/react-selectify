...
function ReactSelectify({ options = [], groups = [], selectedKeys = [], onChange, disabled = false, placeholder, positionOffset = 'bottom', styles = {}, showTooltip = false, className = '', multiple = false, renderOption }) {
     ...
     */
    const handleCheckboxChange = React.useCallback((event, checked, option) => {
        var _a;
    ...
    return (React__default["default"].createElement("div", { className: `th-Multi-Select ${className}`, ref: dropdownRef, style: Object.assign({}, styles['root']) },
        React__default["default"].createElement("div", { className: `th-Input-Wrapper ${disabled ? 'disabled' : ''}` },
            React__default["default"].createElement(react.TextField, { componentRef: inputRef, placeholder: selected.length
                    ? !multiple
                        ? selected[0].text
            ...
            React__default["default"].createElement("div", { className: "th-ChevronDown-Icon" },
                React__default["default"].createElement(react.Icon, { iconName: "ChevronDown", style: { fontSize: 16 } }))),
        isOpen && (React__default["default"].createElement("div", { className: `th-Dropdown ${positionOffset}` },
            React__default["default"].createElement("div", { className: "th-Options-List", style: Object.assign({}, styles['callOut']) }, filteredGroups ? filteredGroups.map((group) => (React__default["default"].createElement("div", { key: group.label, className: "th-Option-Group" },
                React__default["default"].createElement("div", { style: Object.assign({}, styles['groupLabel']), className: "th-Option-GroupLabel" }, group.label),
                group.options.map((option, i) => {
                    ...
                    if (renderOption) {
                        return (React__default["default"].createElement("label", Object.assign({}, defaultProps), renderOption({
                            option,
                            selected: isSelected,
                    ...
                    return (React__default["default"].createElement("label", Object.assign({}, defaultProps),
                        multiple && (React__default["default"].createElement(react.Checkbox, { ariaLabelledBy: option.key, ariaDescribedBy: option.text, checked: isSelected, onChange: (ev, checked) => handleCheckboxChange(ev, checked, option), disabled: option.disabled })),
                        option.text));
...
exports.ReactSelectify = ReactSelectify;
